Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/gilbert889/CustomedRoundView"
  ...
  spec.author             = { "gilbert889" => "gilbertgozalie@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/gilbert889/CustomedRoundView", :tag => "#{spec.version}" }

    # Replace value of source file with your Path
  spec.source_files  = "CustomedRoundView/**/*.{swift}"
